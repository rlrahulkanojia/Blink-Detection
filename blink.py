...
drowsy = 0
state = 0
blinkTime = 0.2     # 100 ms
drowsyTime = 2.0    # 1000 ms
...
def checkEyeStatus( landmarks ):
  ...
  #print(lenLeftEyeSquare, "Distances")
  ...
  #print(normalizedCount, "normalised count")
...
while(1):
  try:
    ...
    #cheking wether eyes are closed or open   
    ...
    if(drowsy):
      cv2.putText(frame, "!!! DROWSY !!! ", (50, 100), cv2.FONT_HERSHEY_COMPLEX, 1.5, (80, 80, 255), 3, cv2.LINE_AA)
    else:
      cv2.putText(frame, "Blinks : {}".format(blinkCount), (50, 50), cv2.FONT_HERSHEY_COMPLEX, .9, (20,60,210), 2, cv2.LINE_AA)
